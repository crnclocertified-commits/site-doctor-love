        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            <div className="inline-flex items-center gap-3 mb-6">
              ...
              <span className="text-foreground/40 text-xs tracking-[0.35em] uppercase">The Build, Documented</span>
              <div className="h-px w-10 bg-foreground/15" />
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-3 border border-border text-foreground text-xs tracking-[0.2em] uppercase px-6 py-4 hover:border-foreground/40 transition-all group"
              >
          ...
          {/* Right side — Inner Circle */}
          <div className="relative">
            <div className="border border-foreground/10 p-10 bg-secondary/30 relative overflow-hidden">

              <div className="relative">
                <p className="text-foreground/30 text-[9px] tracking-[0.4em] uppercase mb-6">Coming Soon</p>
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={pillar} className="flex items-center gap-4">
                      <div className="w-1.5 h-1.5 bg-foreground/30 flex-shrink-0" />
            ...
            {/* Corner accents */}
            <div className="absolute -bottom-4 -right-4 w-16 h-16 border border-foreground/8" />
            <div className="absolute -top-4 -left-4 w-8 h-8 border border-foreground/5" />
          </div>
        </div>
