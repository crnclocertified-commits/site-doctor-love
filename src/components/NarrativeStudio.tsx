      ...
      <div className="relative max-w-screen-xl mx-auto px-6 md:px-12">
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex items-center gap-3 border border-border text-foreground text-xs tracking-[0.2em] uppercase px-6 py-4 hover:border-gold-accent hover:text-gold-accent transition-all group"
              >
          ...
          <div className="relative">
                ...
                <div className="space-y-3">
                  {[
                    ...
                    <div key={pillar} className="flex items-center gap-4">
                      <div className="w-1.5 h-1.5 bg-gold-accent flex-shrink-0" />
            ...
            {/* Corner accents */}
            <div className="absolute -bottom-4 -right-4 w-16 h-16 border border-gold-accent opacity-30" />
            <div className="absolute -top-4 -left-4 w-8 h-8 border border-gold-accent opacity-20" />
          </div>
        </div>
