    ...
    <header className="fixed left-0 right-0 z-50" style={{ top: "36px" }}>
      <nav className="bg-background/95 backdrop-blur-md border-b border-border px-6 md:px-12 py-1 flex items-center justify-between overflow-visible">
        ...
        <div className="hidden md:flex items-center gap-8">
          <a href="https://certifiedrichnarrative.com.au/collections/nc001" target="_blank" rel="noreferrer" className="text-xs tracking-[0.2em] uppercase text-muted-foreground hover:text-gold-accent transition-colors">Shop</a>
          <a href="/our-story" className="text-xs tracking-[0.2em] uppercase text-muted-foreground hover:text-gold-accent transition-colors">Our Story</a>
          <a href="https://certifiedrichnarrative.com.au/collections/nc001" target="_blank" rel="noreferrer" className="text-xs tracking-[0.2em] uppercase text-muted-foreground hover:text-gold-accent transition-colors">NC001</a>
        </div>
        ...
        <div className="flex items-center gap-4">
          <button className="hidden md:flex text-muted-foreground hover:text-gold-accent transition-colors">
            <Search size={18} />
          </button>
          <a
