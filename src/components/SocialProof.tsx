    ...
    <section className="py-16 md:py-24 border-t border-border bg-card">
      <div className="max-w-screen-xl mx-auto px-4 sm:px-6 md:px-12">
        ...
        <div className="text-center mb-10 md:mb-16">
          <p className="text-foreground/40 text-[10px] sm:text-xs tracking-[0.2em] sm:tracking-[0.3em] uppercase mb-3">Founding Chapter</p>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[
            ...
            <div key={i} className="surface p-8 border border-border hover:border-foreground/20 transition-colors">
              <p className="text-foreground/30 text-2xl mb-5">{p.icon}</p>
        ...
        <div className="mt-12 md:mt-20 grid grid-cols-3 gap-3 sm:gap-6 border-t border-border pt-10 md:pt-16">
          ...
          { value: "NC001", label: "Founding Chapter — Active" },
            ...
            <div key={i} className="text-center">
              <p className="font-display text-2xl sm:text-4xl md:text-6xl text-foreground">{s.value}</p>
        ...
        <div className="mt-16 text-center">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="inline-block bg-foreground text-background font-semibold text-xs tracking-[0.25em] uppercase px-12 py-4 hover:bg-foreground/90 transition-all"
          >
